...
def attach_labels_and_tadpole_info_to_npy(csv_file, original_labels_file, db_path, output_file, batch_size=1000000, chunk_size=10000):
    ...
    df = pd.read_csv(csv_file, usecols=['time_series_id'])
    ...
    well_numbers = np.full(len(time_series_ids), -1, dtype=np.int32)
    ...
    with db_handler as db:
        for start_idx in tqdm(range(0, len(time_series_ids), batch_size), desc="Processing batches"):
            ...
            for i in range(start_idx, end_idx):
                ...
                well_numbers[i] = batch_well_number_map.get(time_series_ids[i], -1)
    
    print("Combining time_series_ids, trial_ids, tadpole_ids, well_type_ids, and labels into a single array.")
    final_array = np.column_stack((time_series_ids, trial_ids, tadpole_ids, well_type_ids,well_numbers, labels))
    
    print("Saving the final array to:", output_file)
...
if __name__ == "__main__":
    ...
    # original_labels_file = "/projects/sciences/zoology/geurten_lab/tadpole_project/cluster_results/aug21_davies_bouldin_20to40/delSize_0/k_34/labels/aug21_davies_bouldin_20to40_labels_k34_delSize0_delPosP72.npy"
    # db_path = '/projects/sciences/zoology/geurten_lab/tadpole_project/databases/tadpole_db_july_24'
    # output_file = "/projects/sciences/zoology/geurten_lab/tadpole_project/cluster_analysis/aug_22_k_34/aug21_davies_bouldin_20to40_tadpole_ids_trial_ids_well_type_ids_and_labels.npy"
    
    # For assigning new data
    # csv_file = "/projects/sciences/zoology/geurten_lab/tadpole_project/databases/PTZ_trial_data_sep_10_2024.csv"
    # original_labels_file = "/projects/sciences/zoology/geurten_lab/tadpole_project/cluster_analysis/PTZ_assignment/cluster_labels.npy"
    # db_path = '/projects/sciences/zoology/geurten_lab/tadpole_project/databases/tadpole_db_july_24'
    # output_file = "/projects/sciences/zoology/geurten_lab/tadpole_project/cluster_analysis/PTZ_assignment/sep_12_multi_ptz_amounts_tadpole_ids_trial_ids_well_type_ids_and_labels.npy"
    ...
    db_path = '/projects/sciences/zoology/geurten_lab/tadpole_project/databases/tadpole_db_july_24'
    output_file = "/projects/sciences/zoology/geurten_lab/tadpole_project/cluster_analysis/sep_18_k_36//sep18_davies_bouldin_cleaned_tail_base_x_tadpole_ids_trial_ids_well_type_ids_and_labels.npy"
