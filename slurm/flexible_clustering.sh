...
case $clustering_choice in
    ...
    4)
        ...
        ;;
    5)
        base_cmd="~/miniconda3/envs/rapids-24.06/bin/python /home/matal178/PyProjects/tadpole_wells/clustering_and_analysis_scripts/posture_diff_and_velocity_clustering.py"
        ;;
    *)
